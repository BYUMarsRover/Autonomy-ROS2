#!/usr/bin/env bash
echo 'This file was copied for reference. It is not used in the current system.'
echo 'Please delete this file if it is not needed.'
exit 0
...
ROVER_REPO='~/BYU-Mars-Rover' # default
