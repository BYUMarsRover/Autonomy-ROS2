#/
# This script generates fiducial markers (Aruco markers) as images or PDFs for printing.
# It uses OpenCV to create and format the marker images, which are essential for vision-based 
# detection tasks. This script is useful if you need to create new markers but may not be 
# necessary for core detection functionality.
