...
from rover_msgs.msg import RoverStateSingleton, MobilityVelocityCommands, MobilityArucoAutopilotCommand
...
class ArucoAutopilotManager(Node):
    ...
    def __init__(self):
        ...
        self.kp_linear = self.get_parameter_or('aruco_linear_autopilot_kp', 1.0)
        self.ki_linear = self.get_parameter_or('aruco_linear_autopilot_ki', 0.0)
        self.kd_linear = self.get_parameter_or('aruco_linear_autopilot_kd', 0.0)
        Ts_linear = self.get_parameter_or('aruco_linear_autopilot_Ts', 0.1)
        limit_linear = self.get_parameter_or('aruco_linear_autopilot_limit', 1.0)

        self.kp_angular = self.get_parameter_or('aruco_angular_autopilot_kp', 1.0)
        self.ki_angular = self.get_parameter_or('aruco_angular_autopilot_ki', 0.0)
        self.kd_angular = self.get_parameter_or('aruco_angular_autopilot_kd', 0.0)
        Ts_angular = self.get_parameter_or('aruco_angular_autopilot_Ts', 0.1)
        limit_angular = self.get_parameter_or('aruco_angular_autopilot_limit', 1.0)

        self.low_bound = np.deg2rad(self.get_parameter_or('low_bound', -45.0))
        self.high_bound = np.deg2rad(self.get_parameter_or('high_bound', 45.0))
    ...
    def set_speed(self, request, response):
        ...
        self.linear_controller.kp = self.speed * self.get_parameter_or('linear_autopilot_kp', 1.0)
        self.linear_controller.ki = self.speed * self.get_parameter_or('linear_autopilot_ki', 0.0)
        self.linear_controller.kd = self.speed * self.get_parameter_or('linear_autopilot_kd', 0.0)

        self.angular_controller.kp = self.speed * self.get_parameter_or('angular_autopilot_kp', 1.0)
        self.angular_controller.ki = self.speed * self.get_parameter_or('angular_autopilot_ki', 0.0)
        self.angular_controller.kd = self.speed * self.get_parameter_or('angular_autopilot_kd', 0.0)
