...
R = 6369345.0 # radius of the earth in meters


# Basic class to store a GPS coordinate. Incorperates (==) and .toString() operators
class GPSCoordinate:
...
class GPSTools:
    ...
    def course_angle_between_lat_lon(point1, point2):
        ...
        head_rad, head_degree = GPSTools.heading_between_lat_lon(point1, point2)

        return -head_rad, -head_degree
