...
#         DeclareLaunchArgument('camera', default_value='/zed/left', description='Namespace for camera input'),
#         DeclareLaunchArgument('image', default_value='image_rect_color', description='Image topic name'),
...
#         DeclareLaunchArgument('dictionary', default_value='0', description='Dictionary ID for ArUco detection'),
